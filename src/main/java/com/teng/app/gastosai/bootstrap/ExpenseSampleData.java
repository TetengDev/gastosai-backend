...
public final class ExpenseSampleData {
	...
	public static List<SampleExpense> samples() {
		return List.of(
				...
				new SampleExpense(new BigDecimal("120.00"),  "Transportation",      LocalDateTime.of(2026, 3, 31,  7, 45), "Gas station"),
				new SampleExpense(new BigDecimal("45.00"),   "Transportation",      LocalDateTime.of(2026, 4,  1,  8,  0), "Metro + bus top-up"),
				...
				new SampleExpense(new BigDecimal("2100.00"), "Transportation",      LocalDateTime.of(2026, 4,  3,  9, 30), "Car service"),
