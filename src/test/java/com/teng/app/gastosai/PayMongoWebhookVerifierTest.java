...
class PayMongoWebhookVerifierTest {
    ...
    void blankSecretFailsClosed() {
        ...
        PayMongoWebhookVerifier unconfigured = new PayMongoWebhookVerifier(props);
        // With no webhook secret configured, every signature must be rejected.
        String header = "t=" + TIMESTAMP + ",te=deadbeef";
        assertThat(unconfigured.verify(BODY, header)).isFalse();
    }
